...
window.SITE_CONFIG = {
  ...
  about: {
    ...
    bio:"我叫芦旭，南京大学软件学院23级本科生，在这里分享一些有趣的东西（目前看来有些内容已经不有趣了，特指“疲于应付”系列）\n目前我在准备清华cs的考研（清华也改成408了，唉）\n 我对以下事物抱有较大兴趣，但自认为都不完全了解或者擅长：\n1.cs相关：做过机器学习安全的科研实践，了解一些基于optee的端侧模型推理安全的东西以及machine unlearning(exact unlearning)相关的内容；学习过极少部分Diffusion Model的原理，但是没有时间深入下去，但依旧保持兴趣。\n2.运动相关：有空打一下乒乓球，水平说的过去，但也只是说的过去；在南大赛艇队摸鱼（八单右桨，常坐二号位，但是很长时间没下水了），偶尔去商院拉测功仪，测功仪2000m最好成绩8:10，船道给我的评级是四级精英入门，但我觉得不如高中生；骑行(热衷于不看地图骑到陌生的地方（单程约1h）然后自己找到回学校的路，暂未挑战失败)。\n3.乱七八糟的爱好：5岁开始练习钢琴，16岁停止练习，现在没有任何作品积累，但是喜欢偶尔温习一些之前的曲目（主要是肖邦）。不怎么弹流行。喜欢听肖邦和李斯特，完全不懂作曲，单纯觉得符合我的口味。喜欢听粤语歌，最喜欢的歌手是陈奕迅。最喜欢的作词是黄伟文，最喜欢的作曲是周博贤。同时时也喜欢听（包括但不限于）谢安琪、李克勤、古巨基、张国荣、容祖儿、杨千嬅、黎明、莫文蔚，我最喜欢的粤语歌是《苦瓜》和《四季》（喜欢的的太多了先挑两首写上去吧hhh）。抛开意识形态，我还很钟意林夕的作词。国语歌手我觉得毛不易不错，作词喜欢唐恬和钱雷，作曲喜欢钱雷。喜欢的中国导演有王家卫和姜文，外国导演是诺兰。最喜欢的电影是《一代宗师》。同时爱看梁朝伟、刘青云、吴镇宇的电影，喜欢悬疑片。不爱看电视剧。动画片只看柯南（所以我不懂番，尽量不要跟我讨论相关话题，否则你会失望）。虽然没什么文化但喜欢随便翻一翻书，比较喜欢余华的语言风格（可能因为我俩认识的字都不太多），偶尔看一看《庄子译注》，装一下文化人（其实是只看寓言）。经常翻阅王沪宁《政治的人生》，喜欢这种流水账的风格，有些地方有启示，很多地方看不懂。喜欢刷知乎，每天会瞅一眼Sinya Lee和borntolose的动态（不代表赞同其内容，单纯觉得猎奇）。不玩较长局制或对抗性的电子游戏（可以理解为几乎不玩游戏🎮），偶尔解一下天天象棋的每日残局。喜欢吃辣🌶（香辣而非小米椒之类寡淡的直辣），最喜欢的连锁店是巴奴，一般会点菌汤锅和牛油辣（加麻加辣），但是最近尽量保持清淡饮食，觉得吴叔烧腊和翠香阁不错，偶尔在食堂吃减脂餐。从图书馆去商院时喜欢走苏浙体育场下面的停车场（我个人也觉得这个习惯很奇怪，不要问我为什么，我也不是很理解，只是走过一次之后路线便固定了），大致就这么多，之后想到什么再补充 。"
