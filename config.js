...
window.SITE_CONFIG = {
  ...
  about: {
    ...
    bio:"我叫芦旭，南京大学软件学院23级本科生，在这里分享一些有趣的东西（目前看来有些内容已经不有趣了，特指“疲于应付”系列）\n目前我在准备清华cs的考研（清华也改成408了，唉）\n 我对以下事物抱有较大兴趣，但自认为都不完全了解或者擅长：\n1.cs相关：\n 1.1 机器学习安全\n 1.2 machine unlearning(exact)\n 1.3 Diffusion Model\n2.运动相关：\n 2.1 乒乓球\n 2.2 赛艇\n 2.3 骑行(热衷于不看地图骑到陌生的地方（单程约1h）然后自己找到回学校的路，暂未挑战失败)\n3.乱七八糟的爱好：\n5岁开始练习钢琴，16岁停止练习，现在没有任何作品积累，但是喜欢偶尔温习一些之前的曲目（主要是肖邦），不怎么弹流行。喜欢听肖邦和李斯特，完全不懂作曲，单纯觉得符合我的口味。没什么文化但喜欢随便翻一翻书，比较喜欢余华的语言风格（可能因为我俩认识的字都不太多），偶尔看一看《庄子译注》，装一下文化人（其实是只看寓言）。经常翻阅王沪宁《政治的人生》，喜欢这种流水账的风格，有些地方有启示，很多地方看不懂。喜欢刷知乎，每天会瞅一眼Sinya Lee和borntolose的动态，不玩较长局制或对抗性的电子游戏（可以理解为几乎不玩），偶尔解一下天天象棋的每日残局。喜欢吃辣🌶（香辣而非小米椒之类寡淡的直辣），最喜欢的连锁店是巴奴，一般会点菌汤锅和牛油辣（加麻加辣），但是最近尽量保持清淡饮食，偶尔在食堂吃减脂餐。"
